          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
            ...
            <div className="flex-grow text-center sm:text-left sm:ml-4 md:ml-6 lg:ml-8 mt-3 sm:mt-0">
              <div className="flex items-center justify-center sm:justify-start">
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">{profileData.name}</h1>
                <Link href="/edit-user">
              ...
              <p className="text-white/90 mt-1 sm:mt-2 text-sm sm:text-base">@ : {profileData.username}</p>
              <p className="text-white/90 mt-1 sm:mt-2 text-sm sm:text-base">Bio : {profileData.bio}</p>
