...
import { FaArrowLeft,FaEdit,FaGlobe ,FaPuzzlePiece,FaLinkedin,FaRegUser} from "react-icons/fa";
...
export default function AfterPage() {
  ...
  // Load values from localStorage when page loads
  useEffect(() => {
    setMounted(true);
      ...
      <div className="bg-gradient-to-br from-[#8fb277] to-[#3a6959] w-full py-6 sm:py-8 px-4 sm:px-6 relative">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
            {/* Profile Image - Display image from localStorage if available, otherwise show icon */}
            ...
            <div className="flex-grow text-center sm:text-left sm:ml-4 md:ml-6 lg:ml-8 mt-3 sm:mt-0">
              ...
              <p className="text-white/90 mt-1 sm:mt-2 text-sm sm:text-base">{bio}</p>
